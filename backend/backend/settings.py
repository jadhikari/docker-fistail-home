...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'companyfishtail@gmail.com'
EMAIL_HOST_PASSWORD = 'astyivzezwuehaxl'  # Your Gmail App Password with NO SPACES
DEFAULT_FROM_EMAIL = 'companyfishtail@gmail.com'
